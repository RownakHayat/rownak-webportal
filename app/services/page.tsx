        ...
        <div className="space-y-6">
          {services.map((service, index) => (
            <a
              ...
              key={index}
              className="flex items-center bg-gray-50 p-4 rounded-lg shadow-sm hover:shadow-md transition-all"
            >
              <Image
                src={service.img}
                alt="Services img"
              ...
              />
              <h3 className="text-xl font-semibold text-gray-800 flex-1">{service.title}</h3>
              <svg
