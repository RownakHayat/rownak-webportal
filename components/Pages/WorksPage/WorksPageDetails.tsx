                    ...
                    return images.map((img, i) => (
                      <div key={`${item.id}-${i}`} className="portfolio-item col-span-4">
                        <div className="bg-white rounded-2xl shadow-md overflow-hidden group relative">
                          ...
                          />
                          <div className=" absolute transition-transform duration-900 opacity-100 text-2xl font-semibold text-white pt-10 group-hover:opacity-100 group-hover:text-black group-hover:translate-y-[-3.55rem] group-hover:rounded-lg group-hover:bg-white w-96 h-12 ml-3 group-hover:pl-3 group-hover:pr-4 group-hover:py-2">
